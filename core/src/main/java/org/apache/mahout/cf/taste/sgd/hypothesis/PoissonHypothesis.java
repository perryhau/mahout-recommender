...
/**
 * Hypothesis for Poisson Regression based Recommender Systems
 */
public class PoissonHypothesis extends Hypothesis {

  @Override
  public double[] predict(double[] linearCombination) {
    return new double[] {Math.exp(linearCombination[0])};
  }
