...
public class TestOLSHypothesis extends TasteTestCase {
  ...
  public void predict(){
    ...
    assertArrayEquals(new double[]{10},hypothesis.predict(x, theta),0.001);
    ...
    x = new Vector[]{x4};
    theta = new Vector[]{t4};
    assertArrayEquals(new double[]{4}, hypothesis.predict(x, theta), 0.001);
